...
class Empresa(models.Model):
    ...
    class Meta:
        db_table = 'liquidaciones_empresa'
...
class EmpresasPermitidas(models.Model):
    ...
    class Meta:
        db_table = 'liquidaciones_empresaspermitidas'
...
class Periodo(models.Model):
    ...
    class Meta:
        db_table = 'liquidaciones_periodo'
...
class ConceptoInterno(models.Model):
    ...
    class Meta:
        db_table = 'liquidaciones_conceptointerno'
...
class ConceptoEmpresa(models.Model):
    ...
    class Meta:
        db_table = 'liquidaciones_conceptoempresa'
...
class ParametrosEPS(models.Model):
    ...
    class Meta:
        db_table = 'liquidaciones_parametroseps'
...
class ParametrosAFP(models.Model):
    ...
    class Meta:
        db_table = 'liquidaciones_parametrosafp'
...
class ParametrosFSP(models.Model):
    ...
    class Meta:
        db_table = 'liquidaciones_parametrosfsp'
...
class ParametrosARL(models.Model):
    ...
    class Meta:
        db_table = 'liquidaciones_parametrosarl'
...
class ParametrosSENA(models.Model):
    ...
    class Meta:
        db_table = 'liquidaciones_parametrossena'
...
class ParametrosICBF(models.Model):
    ...
    class Meta:
        db_table = 'liquidaciones_parametrosicbf'
...
class ParametrosCAJA(models.Model):
    ...
    class Meta:
        db_table = 'liquidaciones_parametroscaja'
...
class EPS(models.Model):
    ...
    class Meta:
        db_table = 'liquidaciones_eps'

class FondoPension(models.Model):
    id = models.AutoField(primary_key=True)
    cod_miplanilla = models.IntegerField()
    class Meta:
        db_table = 'liquidaciones_fondopension'
...
class Liquidaciones(models.Model):
    ...
    class Meta:
        db_table = 'liquidaciones_liquidaciones'
