# Generated by Django 3.2.15 on 2022-09-25 21:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_clasificacion', models.CharField(choices=[('salarial', 'Salarial'), ('no_salarial', 'NoSalarial'), ('na', 'NoAplica')], max_length=50)),
                ('tipo_novedad', models.CharField(choices=[('na', 'NoAplica'), ('vac', 'Vacaciones'), ('ige', 'IncapacidadEPS'), ('irl', 'IncapacidadARL'), ('lma', 'LicenciaMaternidad'), ('sln', 'Suspension'), ('avp', 'AporteVoluntario')], default='na', max_length=50)),
                ('tipo_concepto', models.CharField(choices=[('devengo', 'Devengo'), ('descuento', 'Descuento')], max_length=50)),
                ('cuenta_contable', models.CharField(default='', max_length=15)),
                ('desc_cuenta', models.CharField(default='', max_length=100)),
                ('observacion', models.CharField(default='', max_length=130)),
            ],
        ),
        migrations.CreateModel(
            name='Empresa',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mes_periodo', models.CharField(choices=[('01', 1), ('02', 2), ('03', 3), ('04', 4), ('05', 5), ('06', 6), ('07', 7), ('08', 8), ('09', 9), ('10', 10), ('11', 11), ('12', 12)], max_length=3)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cod_concepto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='liquidaciones.conceptoempresa')),
                ('empresa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='liquidaciones.empresa')),
                ('periodo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='liquidaciones.periodo')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('descripcion', models.CharField(max_length=100)),
                ('module', models.CharField(choices=[('preprocesado', 'Preprocesado'), ('conceptos', 'Conceptos'), ('parametros', 'Parametros'), ('liquidaciones', 'Liquidaciones'), ('empresas', 'Empresas')], max_length=30)),
                ('fecha', models.DateTimeField()),
                ('empresa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='liquidaciones.empresa')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ...
        migrations.AddField(
            ...
            name='empresa',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='liquidaciones.empresa'),
        ),
    ]
